...
public class TeleOp_test_andar extends LinearOpMode {
    ...
    /**
     * Futuramente adicionarei um sistema de correção da potencia do lançador em decorrencia da distância da Webcam para a apriltag, em que, será utilizado uma multiplicação da variação da distancia pela constannte de aumento da potencia do lançador que será calculada porteriormente
     */
    //limelight?
    //Modos
